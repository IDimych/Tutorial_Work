...
n["24hnumreward"] = x["24hnumreward"]
n["24hreward"] = x["24hreward"]
n["currentHashrate"] = x["currentHashrate"]
n["hashrate"] = x["hashrate"]
...
with open("etc_2miners_accounts_general.json", "a") as write_file:
